...
VAR_19_20 <- htmlParse("/Users/pedrovela/Documentos/Git_repos/VAR_soccer/getting_data/VAR_in_PL_19-20.html")
#Leemos primero todo el archivo html de la temporada 20/21
VAR_20_21 <- htmlParse("/Users/pedrovela/Documentos/Git_repos/VAR_soccer/getting_data/VAR_in_PL_20-21.html")
...
#analizar si estas tablas individuales por temporada ya están dentro de fpl_merged_seasons
```

```{r}
sort(names(cleaned_players_1617))
sort(names(cleaned_players_1718))
sort(names(cleaned_players_1819))
sort(names(cleaned_players_1920))
sort(names(cleaned_players_2021))
```

```{r}
head(cleaned_players_1617)
```

```{r}
unique(cleaned_merged_seasons$fixture)
```

```{r,include=FALSE}
#Escribimos las tablas en archivos csv para no perderlos
#write_csv(premier_league,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/premier_league.csv")
#write_csv(ovrt_df,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/pl_overturns.csv")
#write_csv(ovrt_var,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/pl_overturns_var.csv")
#write_csv(var_details,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/var_details.csv")
#write_csv(var_details1,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/var_details1.csv")
#write_csv(stats_epl,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/stats_epl.csv")
#write_csv(cleaned_merged_seasons,"/Users/pedrovela/Documents/Git_repos/VAR_soccer/tables/fpl_merged_seasons.csv")
```
