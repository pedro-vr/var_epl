...
df_ply_stats <- df_ply_std_stats %>% left_join(df_ply_gk,by = c('player','team_name','season')) %>% left_join(df_ply_shoots,by = c('player','team_name','season')) %>% left_join(df_ply_passes,by = c('player','team_name','season'))

#Eliminamos los dfs individuales y solo nos quedamos con el general
rm(df_ply_gk,df_ply_std_stats,df_ply_shoots,df_ply_passes)
