...
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Cardiff', 'Cardiff City')
stats_epl$HomeTeam <- sub_value_df(stats_epl$HomeTeam,'Huddersfield', 'Huddersfield Town')
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Huddersfield', 'Huddersfield Town')
stats_epl$HomeTeam <- sub_value_df(stats_epl$HomeTeam,'Hull', 'Hull City')
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Hull', 'Hull City')
stats_epl$HomeTeam <- sub_value_df(stats_epl$HomeTeam,'Leeds', 'Leeds United')
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Leeds', 'Leeds United')
stats_epl$HomeTeam <- sub_value_df(stats_epl$HomeTeam,'Newcastle', 'Newcastle United')
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Newcastle', 'Newcastle United')
stats_epl$HomeTeam <- sub_value_df(stats_epl$HomeTeam,'Stoke', 'Stoke City')
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Stoke', 'Stoke City')
stats_epl$HomeTeam <- sub_value_df(stats_epl$HomeTeam,'Swansea', 'Swansea City')
stats_epl$HomeTeam <- sub_value_df(stats_epl$AwayTeam,'Swansea', 'Swansea City')
...
action_zones$team_name <- sub_value_df(action_zones$team_name,'Newcastle Utd','Newcastle United')
