...
```{r read fivethirtyeight data,include=FALSE}
...
teams_catalog <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/master_team_list.csv')
#leemos el archivo "players_raw" de cada temporada de donde obtendremos el id del jugador y del equipo
pl_raw_1617 <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/players_raw_1617.csv')
pl_raw_1718 <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/players_raw_1718.csv')
pl_raw_1819 <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/players_raw_1819.csv')
pl_raw_1920 <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/players_raw_1920.csv')
pl_raw_2021 <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/players_raw_2021.csv')
pl_raw_2122 <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/players_raw_2122.csv')
...
#del catálogo de los equipos de cada temporada nos quedamos con el nombre
teams_catalog$season <- sapply(teams_catalog$season,as.character) %>% sapply(.,substr,3,length(.)) %>% sapply(.,gsub,pattern="-",replacement="/")
teams_catalog$team_name <- sapply(teams_catalog$team_name,as.character) 

#juntamos ambas tablas para definir el nombre del equipo contrario
merged_gw_formatted <- merged_gw %>% left_join(teams_catalog,by=c('season','opponent_team' = 'team'))
...
#leemos la data
poss_stats <- read.csv('/Users/pedrovela/Documents/Git_repos/var_epl/getting_data/epl_stats_poss.csv')
