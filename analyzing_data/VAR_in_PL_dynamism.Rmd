...
- Número de pases en un radio de 20 yardas --MODIFICAR
- Número de tiros hechos por el equipo contrario: Aquí se le dará un peso dependiendo de la distancia a la cual se realizan estos tiros (basado a su vez en su xG) y a su vez de si éstos fueron hechos a portería o no --MODIFICAR
- Número de pases "peligrosos" o claves que se convierten a su vez en oportunidades de gol
- Número de pases por tiro hecho por el equipo contrario (aquí buscamos solo aquellos valores altos ya que eso define a una "mala defensa") --MODIFICAR
- PPDA (aquí buscamos valores cercanos a cero) --MODIFICAR
- Field Tilt (aquí buscamos valores alejados de cero) --MODIFICAR
...
#Homologamos los nombres de los equipos para el df de gw
df_gw$team_name <- sub_value_df(df_gw$team_name,'Bournemouth','AFC Bournemouth')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Brighton & Hove Albion','Brighton and Hove Albion')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Cardiff','Cardiff City')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Huddersfield','Huddersfield Town')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Hull','Hull City')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Newcastle','Newcastle United')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Stoke','Stoke City')
df_gw$team_name <- sub_value_df(df_gw$team_name,'Swansea','Swansea City')
...
#Homologamos el nombre de los equipos para el df de tiros
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Brighton & Hove Albion','Brighton and Hove Albion')
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Cardiff','Cardiff City')
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Huddersfield','Huddersfield Town')
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Hull','Hull City')
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Newcastle','Newcastle United')
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Stoke','Stoke City')
df_shots$HomeTeam <- sub_value_df(df_shots$HomeTeam,'Swansea','Swansea City')
#Homologamos los nombres de los equipos en el df de poss
df_poss$team <- sub_value_df(df_poss$team,'Brighton & Hove Albion','Brighton and Hove Albion')
df_poss$team <- sub_value_df(df_poss$team,'Cardiff','Cardiff City')
df_poss$team <- sub_value_df(df_poss$team,'Huddersfield','Huddersfield Town')
df_poss$team <- sub_value_df(df_poss$team,'Hull','Hull City')
df_poss$team <- sub_value_df(df_poss$team,'Newcastle','Newcastle United')
df_poss$team <- sub_value_df(df_poss$team,'Stoke','Stoke City')
df_poss$team <- sub_value_df(df_poss$team,'Swansea','Swansea City')
#Homologamos los nombres de los equipos dentro del df del var
df_var$team <- sub_value_df(df_var$team,'Brighton & Hove Albion','Brighton and Hove Albion')
