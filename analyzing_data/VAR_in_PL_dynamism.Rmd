...
- Tiempo de posesión del equipo contrario-falta cruzar para obtener el tiempo de posesión
- Número de pases cruzados completados hechos por el equipo contrario-
- Número de pases en un radio de 20 yardas-
- Número de tiros hechos por el equipo contrario: Aquí se le dará un peso dependiendo de la distancia a la cual se realizan estos tiros (basado a su vez en su xG) y a su vez de si éstos fueron hechos a portería o no.-falta cruzar para obtener tiros y xG
- Número de pases "peligrosos" o claves que se convierten a su vez en oportunidades de gol-
- Número de pases por tiro hecho por el equipo contrario (aquí buscamos solo aquellos valores altos ya que eso define a una "mala defensa")- falta cruzar con tabla para conseguir los tiros
...
```{r sanciones_arbitrales,include=FALSE}
